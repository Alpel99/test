let rectCollision = (firstRect, secondRect) => {
	let {r1x, r1y, r1w, r1h} = {r1x : firstRect.x, r1y : firstRect.y, r1w : firstRect.boxD, r1h : firstRect.boxD}
    let {r2x, r2y, r2w, r2h} = {r2x : secondRect.x, r2y : secondRect.y, r2w : secondRect.boxD, r2h : secondRect.boxD}
